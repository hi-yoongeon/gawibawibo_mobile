...
// in simulator we redefine to format for gawibawibo_mobile Developer console
...
{\
	NSString * exceptionName = [@"org.gawibawibo_mobile." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.gawibawibo_mobile";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIgawibawibo_mobileNativeItemNone = -1, 
	UIgawibawibo_mobileNativeItemSpinner = -2,
	UIgawibawibo_mobileNativeItemProgressBar = -3,
	
	UIgawibawibo_mobileNativeItemSlider = -4,
	UIgawibawibo_mobileNativeItemSwitch = -5,
	UIgawibawibo_mobileNativeItemMultiButton = -6,
	UIgawibawibo_mobileNativeItemSegmented = -7,
	
	UIgawibawibo_mobileNativeItemTextView = -8,
	UIgawibawibo_mobileNativeItemTextField = -9,
	UIgawibawibo_mobileNativeItemSearchBar = -10,
	
	UIgawibawibo_mobileNativeItemPicker = -11,
	UIgawibawibo_mobileNativeItemDatePicker = -12,
	
	UIgawibawibo_mobileNativeItemInfoLight = -13,
	UIgawibawibo_mobileNativeItemInfoDark = -14,
	
	UIgawibawibo_mobileNativeItemDisclosure = -15,
	
	UIgawibawibo_mobileNativeItemContactAdd = -16
};
