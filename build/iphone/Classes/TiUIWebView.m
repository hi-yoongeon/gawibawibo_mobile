...
static NSString * const kgawibawibo_mobileJavascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_gawibawibo_mobileInjection
{
	...
	[html appendString:kgawibawibo_mobileJavascript];
...
{
	// attempt to make well-formed HTML and inject in our gawibawibo_mobile bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _gawibawibo_mobileInjection]];
	...
	else
	{
		...
		if ([[NSFileManager defaultManager] fileExistsAtPath:path])
		{
			...
			else
			{
				...
				{
					NSLog(@"[WARN] I have no idea what the appropriate text encoding is for: %@. Please report this to gawibawibo_mobile support.",url);
				}
			}
