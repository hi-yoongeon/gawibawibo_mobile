...
//@interface gawibawibo_mobileObject : NSObject
//@end

@interface gawibawibo_mobileObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[gawibawibo_mobileObject class]])
		{
			for (NSString *key in [[(gawibawibo_mobileObject*)o modules] allKeys])
			{
